...
public class CliArgs {
    ...
    final static String PASSWORD = "bing";
    final static String PASSWORD_DESC = "mysql password";
    private String password=PASSWORD;

    final static String MAX_CONNECTION = "mysql-max-connection";
    final static int MAX_CONNECTION_DEFAULT = THREAD_DEFAULT / 2;
    final static String MAX_CONNECTION_DESC = "mysql最大连接数(default=" + MAX_CONNECTION_DEFAULT + ")";
    private int maxConnection = MAX_CONNECTION_DEFAULT;

    final static String USER_COUNT = "user-count";
    final static int USER_COUNT_DEFAULT = 5000;
    ...
    final static int MAX_ITEM_PER_USER_DEFAULT = 1;
