...
public interface ItemMapper {
    ...
    @Insert("<script>\r\n"
            + "INSERT INTO item(id,shop_id,item_type,item_name,category_one_id,category_two_id,category_three_id,create_time,create_user,last_modify_time,last_modify_user,is_deleted)\r\n"
            + " VALUES\r\n"
