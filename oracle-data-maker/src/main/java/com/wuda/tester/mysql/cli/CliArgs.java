...
public class CliArgs {
    ...
    final static String MYSQL_URL_DEFAULT = "jdbc:oracle:thin:@host:1521:ORCL";
    final static String MYSQL_URL_DESC = "mysql连接url(default=" + MYSQL_URL_DEFAULT + ")";
    private String mysqlUrl = MYSQL_URL_DEFAULT;

    final static String MYSQL_USERNAME = "bing";
    final static String MYSQL_USERNAME_DESC = "mysql username";
    private String mysqlUsername=MYSQL_USERNAME;

    final static String MYSQL_PASSWORD = "bing";
    final static String MYSQL_PASSWORD_DESC = "mysql password";
    private String mysqlPassword=MYSQL_PASSWORD;
